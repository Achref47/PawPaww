...
const Login = ({ navigation, route }) => {
    ...
    const handleLogin = () => {
        ...
        const email = "chaima@gmail.com"
        const password = "Chaima123"
        if(email && password){
            ...
            .then(async (userCredentials) => {
                ...
                setUser({ UID: userDoc.userId, userId: userDoc.userId, email:userDoc.email,phoneNumber:userDoc.phoneNumber , username: indexOfAlt == -1? user.email : user.email.substring(0, indexOfAlt),hasPetProfile:userDoc?.hasPetProfile,userImage:userDoc?.userImage,friends:userDoc?.friends,frendshipRequests:userDoc?.frendshipRequests,ref:docs.docs[0].ref });
